            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('tarif.add')}}" data-toggle="modal" data-target="#modalForm" class="btn btn-block bg-gradient-primary">Tambah Tarif</a>
                    </div>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
    ...
    <div class="modal fade" id="modalForm">
        <div class="modal-dialog">
            <div class="modal-content">
                <form class="form-horizontal" id="formTarif" action="{{ route('tarif.save') }}" method="POST">
                    @csrf
                    ...
                    <div class="modal-body">
                        <div class="form-group row">
                            <label for="inputNamaLengkap" class="col-sm-3 col-form-label">Title</label>
                            <div class="col-sm-8">
                                <input type="text" name="title" class="form-control"  id="inputNamaLengkap" placeholder="Nama Lengkap">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label for="biaya_cs" class="col-sm-3 col-form-label">Biaya cs</label>
                            <div class="col-sm-3">
...
$(document).ready(function(e){
    ...
    $('#formTarif').on('submit',function(event){
        event.preventDefault();
        var postUrl = "{{ route('tarif.save') }}";

        let dataForm = new FormData( document.getElementById("formTarif") );
