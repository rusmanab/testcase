...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="{{asset('assets/template/adminlte')}}/index2.html" class="h1"><b>MiniPos</b></a>
    </div>
    <div class="card-body">
      ...
      <form method="POST" action="{{ route('login.submit') }}">
        ...
        <div class="input-group mb-3">
            <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" autocomplete="current-password">          <div class="input-group-append">
            <div class="input-group-text">
